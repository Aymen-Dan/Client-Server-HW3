...
public class Processor extends Thread {
        ...
        public static Packet process(Packet inputPacket) throws BadPaddingException, IllegalBlockSizeException {
            ...
            else if (message.getCType() == Message.cTypes.ADD_PRODUCT_TO_GROUP.ordinal()) {
                answer = message.getMessage() + " ADD_PRODUCT_TITLE_TO_GROUP!";
                answerMessage = new Message(Message.cTypes.ADD_PRODUCT_TO_GROUP, 0, answer);
            }
            else {
                answer = message.getMessage() + " OK!";
                answerMessage = new Message(Message.cTypes.RESPONSE, 0, answer);
            }
